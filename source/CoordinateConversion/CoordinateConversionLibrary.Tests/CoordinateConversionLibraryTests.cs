...
namespace CoordinateConversionLibrary.Tests
{
    ...
    public class CoordinateConversionLibraryTests
    {
        ...
        public void ParseDD()
        {
            ...
            Assert.IsFalse(CoordinateDD.TryParse("", false, out coord));
            Assert.IsTrue(CoordinateDD.TryParse("40.273048 -78.847427", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N 78.847427W", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("78.847427W 40.273048N", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N,78.847427W", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsFalse(CoordinateDD.TryParse("40.273048N78.847427W", false, out coord));
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N;78.847427W", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N:78.847427W", false, out coord));
            ...
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("n40.273048 w78.847427", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsFalse(CoordinateDD.TryParse("40.273048N|-78.847427W", false, out coord));
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N/78.847427W", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("40.273048N\\78.847427W", false, out coord));
            Assert.AreEqual(40.273048, coord.Lat);
            Assert.AreEqual(-78.847427, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("45.0° N 100.0° W", false, out coord));
            ...
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("45.0ºN 100.0ºW", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("45.0^N 100.0^W", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            ...
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100.0°W 45.0°N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100.0˚W 45.0˚N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100.0ºW 45.0ºN", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100.0^W 45.0^N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            ...
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100*W 45*N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100W 45N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100- 45+", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("-100 +45", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("-100 45N", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("+100 45S", false, out coord));
            Assert.AreEqual(-45, coord.Lat);
            Assert.AreEqual(100, coord.Lon);
            Assert.IsFalse(CoordinateDD.TryParse("+100+ 45S", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("-100- 45S", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("100- +45-", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("-100- +45+", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("+100W -45S", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("+100E +45N", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("-100W -45S", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("100N 45", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("100S 45", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("100 45E", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("100 45W", false, out coord));
            Assert.IsFalse(CoordinateDD.TryParse("This is not a coordinate", false, out coord));
            ...
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100,0*- 45,0*+", false, out coord));
            Assert.AreEqual(45, coord.Lat);
            Assert.AreEqual(-100, coord.Lon);
            Assert.IsTrue(CoordinateDD.TryParse("100,0*+ 45,0*-", false, out coord));
            Assert.AreEqual(-45, coord.Lat);
        ...
        public void ParseDDM()
        {
            CoordinateDDM coord;
            System.Threading.Thread.CurrentThread.CurrentCulture = System.Globalization.CultureInfo.CreateSpecificCulture("en-GB");
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288',78°50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288', -78°50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288', -078°50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288, -078°50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288, -078 50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288',-078°50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288,-078 50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40°16.38288' -078°50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288 -078 50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288N 078 50.84562W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288n 078 50.84562w", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("N40 16.38288 W078 50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("n40 16.38288 w078 50.84562", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288N|078 50.84562W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288N/078 50.84562W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16.38288N\\078 50.84562W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40-16.38288' -078-50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40_16.38288' -078_50.84562'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("40 16N 078 50W", false, out coord));
            ...
            Assert.IsTrue(CoordinateDDM.TryParse("W078 50.84562 N40 16.38288", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16.38288, coord.LatMinutes);
            Assert.AreEqual(-78, coord.LonDegrees);
            Assert.AreEqual(50.84562, coord.LonMinutes);
            Assert.IsTrue(CoordinateDDM.TryParse("45 0n/100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0n|100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0n\\100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100-0.0W 45-0.0N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("+45 0.0 +100 0.0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45-0N 100-0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("-45 0.0 +100 0.0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("-100 0.0 +45 0.0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45_0.0N 100_0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("N45 0, W100 0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("N45    0   W100   0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("N45 0 W100 0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0n\\100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0 100 0", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0N 100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 08N 100 0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45° 0.0N 100° 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45˚ 0.0N 100˚ 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45º 0.0N 100º 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45^ 0.0N 100^ 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45~ 0.0N 100~ 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45* 0.0N 100* 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0.0′N 100 0.0′W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("45 0.0'N 100 0.0'W", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100° 0.0′W 45° 0.0′N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100° 0.0'W 45° 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100˚ 0.0′W 45˚ 0.0′N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100˚ 0.0'W 45˚ 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100º 0.0′W 45º 0.0′N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100º 0.0'W 45º 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100^ 0.0′W 45^ 0.0′N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100^ 0.0'W 45^ 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100~0.0′W 45~0.0′N", false, out coord));
            ...
            Assert.IsTrue(CoordinateDDM.TryParse("100* 0.0′W 45* 0.0′N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100* 0.0'W 45* 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100 0.0'- 45 0.0'N", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("100 0.0'W 45 0.0'+", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("-100 0.0' -45 0.0'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("+100 0.0' +45 0.0'", false, out coord));
            Assert.IsTrue(CoordinateDDM.TryParse("+100 0.0' 45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("+100 0.0'+ 45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0'+ 45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0'- 45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0' -45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0' -45 0.0'+", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0' N45 0.0'+", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("E100 0.0' S45 0.0'-", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("1234567.1234 1234567.1234", false, out coord));
            Assert.IsFalse(CoordinateDDM.TryParse("This is not a coordinate", false, out coord));
        ...
        public void ParseDMS()
        {
            CoordinateDMS coord;
            System.Threading.Thread.CurrentThread.CurrentCulture = System.Globalization.CultureInfo.CreateSpecificCulture("en-GB");
            Assert.IsTrue(CoordinateDMS.TryParse("40°16'22.9728\", -78°50'50.7372\"", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16, coord.LatMinutes);
            ...
            Assert.IsTrue(CoordinateDMS.TryParse("W78°50'50.7372\", N40°16'22.9728\"", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16, coord.LatMinutes);
            Assert.AreEqual(22.9728, coord.LatSeconds);
            Assert.AreEqual(-78, coord.LonDegrees);
            Assert.AreEqual(50, coord.LonMinutes);
            Assert.AreEqual(50.7372, coord.LonSeconds);
            Assert.IsTrue(CoordinateDMS.TryParse("N40°16'22.9728\", W78°50'50.7372\"", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16, coord.LatMinutes);
            Assert.AreEqual(22.9728, coord.LatSeconds);
            Assert.AreEqual(-78, coord.LonDegrees);
            Assert.AreEqual(50, coord.LonMinutes);
            Assert.AreEqual(50.7372, coord.LonSeconds);
            Assert.IsTrue(CoordinateDMS.TryParse("40°16'22.9728\", -078°50'50.7372\"", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 16' 22.9728\", -78° 50' 50.7372\"", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 7' 22.8\"N 77° 32' 38.4\"W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 7' 22.8\"n 77° 32' 38.4\"w", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("N40° 7' 22.8\" W77° 32' 38.4\"", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("n40° 7' 22.8\" w77° 32' 38.4\"", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 7' 22.8\"N|77° 32' 38.4\"W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 7' 22.8\"N/77° 32' 38.4\"W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("40° 7' 22.8\"N\\77° 32' 38.4\"W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("N40-7-22.8 W77-32-38.4", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("N40_7_22.8 W77_32_38.4", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("N40 16 22, W78 50 50", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16, coord.LatMinutes);
            ...
            Assert.IsTrue(CoordinateDMS.TryParse("+40 16 22, -78 50 50", false, out coord));
            Assert.AreEqual(40, coord.LatDegrees);
            Assert.AreEqual(16, coord.LatMinutes);
            Assert.AreEqual(22, coord.LatSeconds);
            Assert.AreEqual(-78, coord.LonDegrees);
            ...
            Assert.AreEqual(50, coord.LonMinutes);
            Assert.AreEqual(50, coord.LonSeconds);
            Assert.IsTrue(CoordinateDMS.TryParse("45 0 0N 100 0 0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45  1     2, 100 3 4", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45°  1 0.0N 100° 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45˚  1 0.0N 100˚ 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45º   1 0.0N 100º 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45^ 1 0.0N 100^ 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45~ 1 0.0N 100~ 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45* 1 0.0N 100* 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 1' 0.0\"N 100 1' 0.0\"W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 1 0.0N 100 1 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45˚ 1′ 0.0N 100˚ 1′ 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("+45 1 0.0 +100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("-45 1 0.0 +100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("+45 1 0.0 -100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("-45 1 0.0 -100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45-0-0.0N 100-0-0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45-0-0N 100-0-0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45_0_0.0N 100_0_0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 0 0.0N|100 0 0.0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 0 0N|100 0 0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 0 0, 100 0 0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45_0_0N 100_0_0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 0 0N 100 0 0W", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("N45 0 0 W100 0 0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("-45 1 0.0 +100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 1 0.0- +100 1 0.0", false, out coord));
            Assert.IsTrue(CoordinateDMS.TryParse("45 1 0.0- 100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("-45 1 0.0- 100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("-45 1 0.0+ 100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("45 1 0.0+ -100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("-45 1 0.0+ +100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("N45 1 0.0+ 100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("45 1 0.0+ S100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("N45 1 0.0N 100 1 0.0", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("-45 1 0.0S 100 1 0.0-", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("1234567.1234 1234567.1234", false, out coord));
            Assert.IsFalse(CoordinateDMS.TryParse("This is not a coordinate", false, out coord));
    ...
    public class CCTestsFromJson
    {
        ...
        public void ParseDMSFromJSON()
        {
            ...
            foreach (var item in testList)
            {
                ...
                Assert.IsTrue(CoordinateDMS.TryParse(item.Output, false, out coord),
                    coord + " != " + item);
            }
        }
        ...
        public void ParseDDMFromJSON()
        {
            ...
            foreach (var item in testList)
            {
                ...
                Trace.WriteLine("Test Coord: " + item.Output);
                Assert.IsTrue(CoordinateDDM.TryParse(item.Output, false, out coord),
                    coord + " != " + item);
            }
        }
